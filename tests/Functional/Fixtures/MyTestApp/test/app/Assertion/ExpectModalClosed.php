...
/**
 * Class ExpectModalClosed.
 *
 * Declares that the next logged transition must be a modal becoming hidden.
 * May be used in either the arrangement or assertion stage of a scenario.
 *
 * @author Dan Phillimore <dan@ovms.co>
 */
class ExpectModalClosed implements ArrangementInterface, AssertionInterface
{
    ...
    {
        $environment->assertTransition(new ModalClosedTransition($this->handle));
    }
}
